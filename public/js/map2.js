;!function (win, $, undefined) {
    var SVGMap2 = (function () {
        function SVGMap2(dom, options) {
            this.dom = dom;
            this.setOptions(options);
            this.render();
        }

        SVGMap2.prototype.options = {
            mapName: 'china',
            mapWidth: 500,
            mapHeight: 400,
            stateColorList: ['fd0000', 'ff5400', 'ffa200', 'ffd800', 'f3e387', 'f2e6a0', 'fdfbd2'],
            ...
            stateInitColor: 'fdfbd2',
            stateHoverColor: '429DD4',
        ...
        SVGMap2.prototype.setOptions = function (options) {
            if (options == null) {
                options = null;
            }
        ...
        SVGMap2.prototype.scaleRaphael = function (container, width, height) {
        ...
        SVGMap2.prototype.render = function () {
    ...
    $.fn.SVGMap2 = function (opts) {
        ...
        if (opts !== false) {
            data.SVGMap2 = new SVGMap2($this, opts);
        }
        return data.SVGMap2;
    };
}(window, jQuery);
$(function () {
    axios.get('/api/getTempMaxMap')
        .then(function (response) {
            ...
            var mapObj_1 = {};
            var stateColorList = ['fd0000', '0058B0', '0071E1', '1C8DFF', '51A8FF', '82C0FF', 'AAD5ee', 'AAD5FF'];
